...
export default function EditProduct({ params }) {
  ...
  if (!authChecked || !loaded) {
    return <main className="min-h-screen bg-[#F0F7FF] flex items-center justify-center"><div className="text-[#6B7080] text-sm">Loading...</div></main>;
  }
  ...
  return (
    <main className="min-h-screen bg-[#F0F7FF] py-8">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <h1 className="text-2xl font-semibold text-[#1E293B] mb-8">Edit Product</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 border border-[#E2E8F0] space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                <label className="block text-sm font-medium text-[#475569] mb-1">Original Price</label>
              ...
              <div className="md:col-span-2">
                ...
                <input type="text" value={form.image} onChange={e => updateField('image', e.target.value)}
                  ...
                  className="w-full rounded-xl border border-[#E2E8F0] px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#2563EB] focus:border-transparent" />
                {form.image && (
                  <div className="mt-3 w-24 h-24 rounded-xl overflow-hidden bg-[#F1F5F9] border border-[#E2E8F0]">
          ...
          <div className="flex items-center gap-4 pt-2">
            <button type="submit" disabled={saving}
              ...
              <Save size={16} /> {saving ? 'Saving...' : 'Update Product'}
            </button>
