      ...
      <div className="max-w-4xl mx-auto px-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: [0.16,1,0.3,1] }}>
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-[10px] font-medium tracking-[0.2em] uppercase text-[#0071E3]">About</span>
          </div>
          <h1 className="text-3xl md:text-5xl font-bold tracking-tighter text-[#1D1D1F] mb-4">About Core Tech Systems</h1>
          <p className="text-sm text-[#6B7080] font-light max-w-lg mb-12">Harare&apos;s premier destination for premium technology, repairs, and gaming.</p>
        </motion.div>

        <div className="card p-8 md:p-10 mb-8">
          <h2 className="text-lg font-semibold text-[#1D1D1F] mb-4">Our Story</h2>
          <p className="text-sm text-[#6B7080] font-light leading-relaxed mb-4">
          ...
          <p className="text-sm text-[#6B7080] font-light leading-relaxed">
          ...
          {[
            ...
            return (
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 * i }} className="card p-6">
                ...
                <p className="text-xs text-[#6B7080] font-light">{item.desc}</p>
              </motion.div>
            );
          })}
        </div>
        ...
        <div className="card p-8">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-[#6B7080] font-light">Corner Speke & Mbuya Nehanda<br />Sirus Mall, 1st Floor<br />Harare, Zimbabwe</p>
              <p className="text-sm text-[#6B7080] font-light mt-2">Monday — Saturday: 08:30 – 17:00</p>
            </div>
          </div>
        </div>
      </div>
