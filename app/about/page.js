      ...
      <div className="max-w-4xl mx-auto px-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: [0.16,1,0.3,1] }}>
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-[10px] font-medium tracking-[0.2em] uppercase text-neutral-400">About</span>
          </div>
          <h1 className="text-3xl md:text-5xl font-bold tracking-tighter text-white mb-4">About Core Tech Systems</h1>
          <p className="text-sm text-neutral-400 font-light max-w-lg mb-12">Harare&apos;s premier destination for premium technology, repairs, and gaming.</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          {[
            ...
            return (
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 * i }} className="card p-6">
        ...
        <div className="card p-8">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              <h3 className="text-sm font-semibold text-white mb-2">Visit Our Showroom</h3>
              <p className="text-sm text-neutral-400 font-light">Corner Speke & Mbuya Nehanda<br />Sirus Mall, 1st Floor<br />Harare, Zimbabwe</p>
              <p className="text-sm text-neutral-400 font-light mt-2">Monday — Saturday: 08:30 – 17:00</p>
            </div>
          </div>
        </div>
      </div>
