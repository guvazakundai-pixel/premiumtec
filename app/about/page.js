      ...
      <div className="max-w-4xl mx-auto px-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: [0.16,1,0.3,1] }}>
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-[10px] font-medium tracking-[0.25em] uppercase text-white/30">About</span>
          </div>
          <h1 className="text-3xl md:text-5xl font-bold tracking-tighter text-[#F5F7FA] mb-4">About PremiumTec</h1>
          <p className="text-sm text-white/30 font-light max-w-lg mb-12">Zimbabwe&apos;s premier destination for flagship technology.</p>
        </motion.div>

        <div className="product-card p-8 md:p-10 mb-8">
          <h2 className="text-lg font-semibold text-white/80 mb-4">Our Story</h2>
          <p className="text-sm text-white/40 font-light leading-relaxed mb-4">
            Founded in Harare, PremiumTec was built with a single mission: to bring Zimbabwe&apos;s most discerning
            technology enthusiasts access to the world&apos;s finest flagship devices.
          </p>
          <p className="text-sm text-white/40 font-light leading-relaxed">
            We believe that premium technology should be accessible, authentic, and backed by exceptional service.
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          {[
            ...
            { icon: Award, title: 'Premium Standards', desc: 'Meticulously curated collection of the finest flagship technology.' },
        ...
        <div className="product-card p-8">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              <h3 className="text-sm font-semibold text-white/80 mb-2">Visit Our Showroom</h3>
