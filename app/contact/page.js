      ...
      <div className="max-w-4xl mx-auto px-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: [0.16,1,0.3,1] }}>
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-[10px] font-medium tracking-[0.2em] uppercase text-neutral-400">Contact</span>
          </div>
          <h1 className="text-3xl md:text-5xl font-bold tracking-tighter text-white mb-4">Get in Touch</h1>
          <p className="text-sm text-neutral-400 font-light max-w-lg mb-12">We&apos;d love to hear from you.</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
            <div className="card p-8 space-y-6">
              <h2 className="text-lg font-semibold text-white">Visit Us</h2>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <MapPin size={16} className="text-neutral-400 mt-0.5 shrink-0" />
                  <div><p className="text-sm text-white">Sirus Mall, 1st Floor</p><p className="text-xs text-neutral-400">Corner Speke & Mbuya Nehanda, Harare</p></div>
                </div>
                <div className="flex items-start gap-3">
                  <Clock size={16} className="text-neutral-400 mt-0.5 shrink-0" />
                  <div><p className="text-sm text-white">Monday — Saturday</p><p className="text-xs text-neutral-400">08:30 – 17:00</p></div>
                </div>
                <div className="flex items-start gap-3">
                  <Phone size={16} className="text-neutral-400 mt-0.5 shrink-0" />
                  <div><p className="text-sm text-white">+263 780 579 633</p><p className="text-xs text-neutral-400">+263 71 071 3518</p></div>
                </div>
              </div>
            </div>
