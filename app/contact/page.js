      ...
      <div className="max-w-4xl mx-auto px-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: [0.16,1,0.3,1] }}>
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-[10px] font-medium tracking-[0.2em] uppercase text-[#86868B]">Contact</span>
          </div>
          <h1 className="text-3xl md:text-5xl font-bold tracking-tighter text-[#1D1D1F] mb-4">Get in Touch</h1>
          <p className="text-sm text-[#6E6E73] font-light max-w-lg mb-12">We&apos;d love to hear from you.</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
            <div className="card-gray p-8 space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div><p className="text-sm text-[#1D1D1F]">Sirus Mall, 1st Floor</p><p className="text-xs text-[#6E6E73]">Corner Speke & Mbuya Nehanda, Harare</p></div>
                </div>
                <div className="flex items-start gap-3">
                  <Clock size={16} className="text-[#0071E3] mt-0.5 shrink-0" />
                  <div><p className="text-sm text-[#1D1D1F]">Monday — Saturday</p><p className="text-xs text-[#6E6E73]">08:30 – 17:00</p></div>
                </div>
                <div className="flex items-start gap-3">
                  <Phone size={16} className="text-[#0071E3] mt-0.5 shrink-0" />
                  <div><p className="text-sm text-[#1D1D1F]">+263 780 579 633</p><p className="text-xs text-[#6E6E73]">+263 708 463 628</p></div>
                </div>
              </div>
            </div>

            <div className="card-gray p-8 mt-4">
              ...
              <a href="https://threads.net/@coretechsystems_zw" target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-xs text-[#6E6E73] hover:text-[#0071E3] transition-colors">
